...
The protected manager deploy checkout is
`/Users/kilgore/Dropbox/Code/cane/id-agents-deploy-main`. The gate and any manual
redeploy follow-up should target that checkout's `origin/main`, not the dirty
developer checkout.
