...
function healthReadyAdmissionOptions(readyAdmission: ReadyAdmissionExplanation) {
  return {
    ...
    rootReadyFuel: readyAdmission.root_ready_fuel,
    rootReadyLanes: readyAdmission.root_ready_lanes,
    admissibleRootNow: readyAdmission.admissible_root_now,
    capacityBlockedRoot: readyAdmission.capacity_blocked_root,
    deferredDescendants: readyAdmission.deferred_descendants,
    brokenDependencyRows: readyAdmission.broken_dependency_rows,
    fuelExclusionCounts: readyAdmission.fuel_exclusion_counts,
    stateDriftReadyWithPendingDependency: readyAdmission.state_drift_ready_with_pending_dependency,
